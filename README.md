...
- **Must include a picture**: PRs must contain at least one image uploaded directly to the PR description (GitHub attachment). No pic, no merge. What the picture is? That's your business.
