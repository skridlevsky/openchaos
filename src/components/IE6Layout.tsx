  ...
  return (
    <>
      ...
      <IE6BrowserChrome>
        ...
        <main className="ie6-main">
          ...
          >
            <tbody>
                          ...
                          <span className="ie6-header-text">
                            <b>
                              ...
                              <marquee behavior="alternate" scrollamount="10">
                                <span className="sparkle-rotate-glint">⭐</span>{' '}
                                OPENCHAOS.DEV{' '}
                                <span className="sparkle-rotate-glint sparkle-delay-2">
                                  ⭐
                                </span>
                                {/* @ts-expect-error marquee is deprecated but used for retro styling */}
                              </marquee>
                ...
                <td className="ie6-marquee-cell">
                  <span className="ie6-marquee-text">
                    ...
                    <marquee scrollamount="5" width="100%">
                      🚧 UNDER CONSTRUCTION 🚧 Welcome to the WORLD WIDE WEB! 🚧
              ...
              <tr>
                <td className="ie6-content-cell">{children}</td>
              </tr>
                      ...
                      <tr>
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <img
                                src="/buttons/discord88x31.gif"
                                alt="Join OpenChaos Discord!"
                                width="88"
                                height="31"
                                className="discord-button-88x31"
                              />
                            </a>
                            <a
                              href="https://blog.openchaos.dev/"
                              target="_blank"
                              rel="noopener noreferrer"
                            >
                              <img
                                src="/buttons/2cows.gif"
                                alt="2 Cows and a Chicken button - visit our site"
                                width="88"
                                height="31"
                              />
                            </a>
                            ...
                            >
                              <img
                                src="/buttons/3dkingdom.gif"
                                alt="3D Kingdom button - visit our site"
                                width="88"
                                height="31"
                              />
                            </a>
                            ...
                            >
                              <img
                                src="/buttons/angelfire.gif"
                                alt="Angelfire hosting button"
                                width="88"
                                height="31"
                              />
                            </a>
                            ...
                            >
                              <img
                                src="/buttons/FreewareGuide.gif"
                                alt="Freeware Guide button"
                                width="88"
                                height="31"
                              />
                            </a>
                            ...
                            >
                              <img
                                src="/buttons/geocitieswww.gif"
                                alt="GeoCities web hosting button"
                                width="88"
                                height="31"
                              />
                            </a>
                            ...
                            >
                              <img
                                src="/buttons/lycos.gif"
                                alt="Lycos search engine button"
                                width="88"
                                height="31"
                              />
                            </a>
              ...
              <tr>
                <td className="ie6-footer-cell">
                  <span className="ie6-bottom-banner-text">
                    {/* @ts-expect-error marquee is deprecated but used for retro styling */}
                    <marquee>
                      💿 Download Internet Explorer 6 NOW for the BEST browsing
                      experience! 💿{' '}
                      <a
                      ...
                      💿{' '}
                      <a
                        href="https://www.real.com/"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="realplayer-link"
                      >
                        Get RealPlayer
                      </a>
                      ! 💿
        ...
        <MidiPlayer
          isOpen={isMidiPlayerOpen}
          onClose={() => setIsMidiPlayerOpen(false)}
        />
