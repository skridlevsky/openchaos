...
const STATIONS: RadioStation[] = [
  {
    id: 'afro_beat',
    name: 'International Funk 99',
    logo: '/build/games/assets/afro_beat-DG46T5pG.png',
  },
  {
    id: 'babylon',
    name: 'Tuff Gong Radio',
    logo: '/build/games/assets/babylon-DFPNbeje.png',
  },
  {
    id: 'the_vibe',
    name: 'The Vibe 98.8',
    logo: '/build/games/assets/the_vibe-8G0n8AgW.png',
  },
  {
    id: 'liberty_rock',
    name: 'Liberty Rock Radio 97.8',
    logo: '/build/games/assets/liberty_rock-_KkSFRMc.png',
  },
  {
    id: 'jazz_nation',
    name: 'Jazz Nation Radio 108.5',
    logo: '/build/games/assets/jazz_nation-xihCJ2LH.png',
  },
  {
    id: 'bobby_konders',
    name: 'Massive B Soundsystem 96.9',
    logo: '/build/games/assets/bobby_konders-BakHYsXc.png',
  },
  {
    id: 'meditation',
    name: 'Self Actualization FM',
    logo: '/build/games/assets/meditation-BFYAG2d3.png',
  },
  {
    id: 'k109_the_studio',
    name: 'K109 The Studio',
    logo: '/build/games/assets/k109_the_studio-jSHMlYLJ.png',
  },
  {
    id: 'vcfm',
    name: 'Vice City FM',
    logo: '/build/games/assets/vcfm-C2GwzKEn.png',
  },
  {
    id: 'wktt',
    name: 'We Know The Truth',
    logo: '/build/games/assets/wktt-DXPQ0n7t.png',
  },
  {
    id: 'hardcore',
    name: 'Liberty City Hardcore',
    logo: '/build/games/assets/hardcore-DX5ZNchq.png',
  },
  {
    id: 'classical_ambient',
    name: 'The Journey',
    logo: '/build/games/assets/classical_ambient-IIXQZhsa.png',
  },
  {
    id: 'fusion_fm',
    name: 'Fusion FM',
    logo: '/build/games/assets/fusion_fm-Be5GtpDw.png',
  },
  {
    id: 'beat_95',
    name: 'The Beat 102.7',
    logo: '/build/games/assets/beat_95-Vka9ahZu.png',
  },
  {
    id: 'ramjamfm',
    name: 'Ram Jam FM',
    logo: '/build/games/assets/ramjamfm-Bd4L2rme.png',
  },
  {
    id: 'dance_rock',
    name: 'Radio Broker',
    logo: '/build/games/assets/dance_rock-DWpXjK7P.png',
  },
  {
    id: 'vladivostok',
    name: 'Vladivostok FM',
    logo: '/build/games/assets/vladivostok-BkOA1X3o.png',
  },
  {
    id: 'plr',
    name: 'Public Liberty Radio',
    logo: '/build/games/assets/plr-chB_Uny6.png',
  },
  {
    id: 'san_juan_sounds',
    name: 'San Juan Sounds',
    logo: '/build/games/assets/san_juan_sounds-YeApARPs.png',
  },
  {
    id: 'dance_mix',
    name: 'Electro Choc',
    logo: '/build/games/assets/dance_mix-DSnkVSVs.png',
  },
  {
    id: 'ny_classics',
    name: 'The Classics 104.1',
    logo: '/build/games/assets/ny_classics-DOFK-p55.png',
  },
  {
    id: 'lazlow',
    name: 'Integrity 2.0',
    logo: '/build/games/assets/lazlow-CVZww43x.png',
  },
];
      ...
      <div className="gta-radio-overlay">
        <div className="gta-radio-header">
          ...
          <div className="gta-radio-header-buttons">
            ...
            <button
              onClick={() =>
                setAlignment(alignment === 'right' ? 'left' : 'right')
              }
              className="gta-radio-header-btn"
          ...
          <>
            <div className="gta-radio-display">
              ...
              <div className="gta-radio-info">
                <div className="gta-radio-station-name">
                  {currentStation.name}
                </div>
