  ...
  return (
    <div className="ie6-browser-window">
      ...
      <div className="ie6-content-wrapper">
        ...
        {showSearchPanel && (
          <div className="ie6-side-panel">
            ...
            <div className="ie6-panel-content">
              ...
              <div
                style={{ marginTop: '16px', fontSize: '11px', color: '#666' }}
              >
                <p>
                  <strong>Popular Search Engines:</strong>
                </p>
            ...
            <div className="ie6-panel-content">
              <div className="ie6-favorites-list">
                ...
                <div
                  ...
                  onClick={() =>
                    window.open(
                      'https://github.com/bpottle/openchaos',
                      '_blank',
                    )
                  }
                >
                ...
                <div
                  className="ie6-favorite-item"
                  onClick={() =>
                    window.open('https://www.zombo.com/', '_blank')
                  }
                >
                  <span className="ie6-favorite-icon">⚡</span>
                  <span>Zombocom</span>
                ...
                <div
                  className="ie6-favorite-item ie6-favorite-discord"
                  onClick={() =>
        ...
        <div className="ie6-content-area">{children}</div>
      </div>
    </div>
  );
}
