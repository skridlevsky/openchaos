    ...
    <div className="web2-browser-window">
      ...
      <div className="web2-titlebar">
        ...
        <span className="web2-titlebar-text">
          {user
            ? `OpenChaos.dev — ${user.login} — Mozilla Firefox`
            : 'OpenChaos.dev — Mozilla Firefox'}
        </span>
        <div style={{ width: 54 }} />
      </div>
      ...
      <div className="web2-navbar">
        ...
        <button
          ...
          style={showBookmarksPanel ? { background: '#ddd' } : {}}
        >
          <svg
            width="14"
            height="14"
      ...
      <div className="web2-content-wrapper">
          ...
          <div className="web2-side-panel">
            ...
            <div className="web2-panel-content">
              <div className="web2-bookmarks-list">
                ...
                <div
                  className="web2-bookmark-item web2-bookmark-discord"
                  onClick={() =>
                ...
                <div
                  className="web2-bookmark-item"
                  onClick={() => window.open('https://digg.com', '_blank')}
                >
                  <span className="web2-bookmark-icon">
                    <svg
                      width="14"
                      ...
                      fill="currentColor"
                    >
                      <path d="M6 2h4v18H2V8h4V2zm0 14v-4H6v4zm10-8h4v12h-8v-4h4V8zm0 8v-4h-0v4zM12 8h4v4h-4V8zm0-6h4v4h-4V2z" />
                    </svg>
                  </span>
                  <span>Digg</span>
                </div>
                <div
                  className="web2-bookmark-item"
                  onClick={() => window.open('https://del.icio.us', '_blank')}
                >
                  <span className="web2-bookmark-icon">
                    <svg
                      width="14"
                ...
                <div
                  className="web2-bookmark-item"
                  onClick={() =>
                    window.open('https://www.stumbleupon.com', '_blank')
                  }
                >
                  <span className="web2-bookmark-icon">
                    <svg
                    ...
                    >
                      ...
                      <path d="M22 12c0-2-1-3-2.5-3S17 10 17 12v1.5" />
                      <path d="M12 8c-2.2 0-4 1.8-4 4v2c0 2.2 1.8 4 4 4s4-1.8 4-4" />
                    </svg>
                  </span>
                ...
                >
                  <span className="web2-bookmark-icon">
                    <svg
                      ...
                      fill="#0a9b00"
                    >
                      <path d="M4 4h16v3H4zm0 6h10v3H4zm0 6h13v3H4z" />
                    </svg>
                  </span>
                ...
                <div
                  className="web2-bookmark-item"
                  onClick={() => window.open('https://wordpress.com', '_blank')}
                >
                  <span className="web2-bookmark-icon">
                    <svg
                      width="14"
        ...
        <div className="web2-content-area">{children}</div>
      </div>
    </div>
  );
}
