      ...
      <Web2BrowserChrome>
        ...
        <div className="web2-announcement-bar">
          <span className="web2-announcement-text">
            Welcome to OpenChaos.dev — The community-driven, self-evolving open
            source project! Vote on PRs. Winner gets merged daily at 19:00 UTC.
          </span>
        </div>
        <Web2BetaBadge />
        ...
        <main className="web2-main">
          <div className="web2-page-wrapper">
            ...
            <div className="web2-two-col">
              {/* Main Content */}
              <div className="web2-col-main">{children}</div>
